...
class Align2Marker:
    ...
    def get_marker(self, msg): #====================================================================
        ...
        if( self.marker_found_2nd == False):
            ...
            self.th_3 = abs(abs(self.th_2)-abs(self.th_1)) / 2
           ...
           #self.dist_x = self.dist * cos(self.theta)
            ...
            #'''
            print("2 touch theta = %f" %(self.theta/0.0174533))
            #print("odom = %f" % (self.th_3/0.0174533))
            #print("dist_x = %f, dist_y = %f" % (self.dist_x, self.dist_y))
    ...
    def turn_forward(self):
        ...
        #self.theta = (radians(90) - self.theta) 
        #self.th_3 = (radians(90) - self.th_3) / 2
        print("go to forward theta = %f" % (self.theta/0.0174533))
    ...
    def get_ar_pose(self, msg, rpy):   # case of marker rpy=1, case of odom rpy=2
        ...
        * p: euler_from_quaternion(q)[1] | pitch  (y) | (z) yaw ** | <-- 
        ...
        #if rpy == 1:
           # print("no touch theta = %f " % (theta/0.0174533))
        if theta < 0:
            theta = theta + pi * 2
        if theta > pi * 2:
            theta = theta - pi * 2
